...
const domain = ref("");
const record = ref("");
const tld = ref("web3shift");
const CONTRACT_ADDRESS = "0x9FBbcD60641F18159D9252C3230e447F4e80B0f6";
...
async function mintDomain() {
  ...
  if (domain.value.length < 3) {
    alert("domain name must be longer than 3");
    return;
  }
...
<template>
  <div className="form-container">
    ...
    <input type="text" v-model="record" placeholder="Description" />
